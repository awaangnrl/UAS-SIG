...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [108.693101, -7.351504, 109.196866, -6.758506],
            units: 'degrees'})
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0,
      colName: 'WADMKC',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([108.480221, -7.366329, 109.409746, -6.743681], map.getSize());
